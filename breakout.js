...
function update(){
    ...
    if (ball.y <= 0){
        ...
        context.fillText("Game Over: Press 'Space' to Restart", 140, 300);
        gameOver = true;
    }
    ...
    //next level
    if (blockCount == 0){
        score += 100*blockRows*blockColums; //bonus points
...
function detectCollision(a, b){
    return a.x < b.x + b.width && //a's top of left corner doesn't reach b's top right corner
